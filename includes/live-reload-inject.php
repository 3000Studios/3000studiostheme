 ...
 * BlackVault SUPREME Live Reload Injection
 */
...
function studios_inject_live_reload() {
    // Only in development mode or if explicitly enabled
    if (!defined('WP_DEBUG') || !WP_DEBUG) {
        return;
    }
    
    // Check if live reload is enabled via option or constant
    $live_reload_enabled = get_option('studios_live_reload_enabled', true);
